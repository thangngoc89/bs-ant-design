[@bs.module "antd/lib/tabs"] external tabs: ReasonReact.reactClass = "default";
...
type jsProps = {
  ...
  [@bs.optional]
  onTabClick: ReactEvent.Mouse.t => unit,
  [@bs.optional]
  onPrevClick: ReactEvent.Mouse.t => unit,
  [@bs.optional]
  onNextClick: ReactEvent.Mouse.t => unit,
  [@bs.optional]
  tabBarExtraContent: ReasonReact.reactElement,
  [@bs.optional]
  tabBarStyle: ReactDOMRe.Style.t,
  [@bs.optional] [@bs.as "type"]
  _type: string, /* tabsType, */
  [@bs.optional]
  tabPosition: string, /* tabsPosition, */
  /* TODO */
  ...
  ReasonReact.wrapJsForReason(
    ...
    ~props=
      jsProps(
        ...
        ~tabPosition=?
          Js.Option.map((. b) => tabsPositionToJs(b), tabPosition),
...
module TabPane = {
  [@bs.module "antd/lib/tabs"] [@bs.scope "default"]
